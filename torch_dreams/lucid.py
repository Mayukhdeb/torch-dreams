...
class Hook():
    def __init__(self, module, backward=False):
        ...
        # print("hook init on module:   ", module)
...
class dreamer(object):
    ...
    def get_gradients(self, net_in, net, layer, channel  = None, custom_func = None):   
        """
        ...
        here's a link in case you dont understand whats norm(){
        ...
        if custom_func is not None:
            loss = custom_func(loss)

        else:
            loss = loss.norm()  ## simple vector norm
    ...
    def dream_on_octave(self, image_np, layer, iterations, lr,  channel  = None, custom_func = None):
        ...
        for i in range(iterations):
            ...
            gradients_tensor = self.get_gradients(image_tensor_rolled, self.model, layer,  channel  = channel , custom_func= custom_func).detach()
    ...
    def deep_dream(self, image_np, layer, octave_scale, num_octaves, iterations, lr, channel  = None, custom_func = None):
        ...
        for n in tqdm(range(-num_octaves, 1)):
            ...
            image_np = self.dream_on_octave(image_np, layer =  layer, iterations = iterations, lr = lr, channel  = channel , custom_func= custom_func)
    ...
    def progressive_deep_dream(self, image_path, save_name , layer, octave_scale, num_octaves, iterations, lower_lr, upper_lr, num_steps, framerate = 15, size = None, channel  = None):
